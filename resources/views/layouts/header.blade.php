                ...
                <div class="header-login">
                    @if (session('auth'))
                        <div class="dropdown-example">
                            <div class="row">
                                <div class="col">
                                    <div>
                                        <button class="br-button circle small" type="button" id="triggerexample"
                                            data-toggle="dropdown" aria-label="Abrir Acesso Rápido"
                                            data-target="target"><i class="fas fa-ellipsis-v" aria-hidden="true"></i>
                                        </button>
                                        <div class="br-list target" id="target" hidden="hidden">
                                            <div class="header">
                                                <div class="title">Acesso Rápido</div>
                                            </div><a class="br-item" href="{{ route('logout') }}">Sair</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @else
                        <div class="header-sign-in">
                            <a href="{{ route('login') }}" class="br-sign-in small" data-trigger="login"><i
                                    class="fas fa-user" aria-hidden="true"></i><span class="d-sm-inline">Entrar</span>
                            </a>
                        </div>
                ...
                <form action="{{ route('search') }}" method="get">
                    <div class="header-search">
                        <div class="br-input has-icon">
                            <label for="patente">Texto da pesquisa</label>
                            <input id="patente" name="patente" type="text" placeholder="Buscar patente" />
                            <button class="br-button circle small" type="submit" aria-label="Pesquisar"><i
